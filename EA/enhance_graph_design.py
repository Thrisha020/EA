...
"""
Changes the design of the dependency graph visualization to be more modern and clean.
Features:
- Capsule-shaped nodes
- Curved dotted lines
...
def visualize_dependencies_advanced(object_name, dependencies):
    ...
    # Save and display
    output_file_name = "advanced_dependency_graph.html"
...
def main():
    ...
    if object_id:
        ...
        if dependencies:
            ...
            visualize_dependencies_advanced(object_name, dependencies)
            #visualize_dependencies(object_name, dependencies)
